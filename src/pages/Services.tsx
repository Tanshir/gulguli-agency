    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
            {services.map((service, index) => (
              <Card 
                key={service.title} 
                className="bg-card border-border hover:border-foreground transition-all duration-300 group"
              >
                <CardContent className="p-8 lg:p-10">
                  <div className="w-16 h-16 bg-foreground flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
      ...
      <section className="py-20 bg-muted">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 text-foreground">Additional Services</h2>
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Link to="/services/seo-optimization">
              <Card className="bg-card border-border hover:border-foreground transition-colors duration-300 cursor-pointer">
                <CardContent className="p-8">
                  <h3 className="text-xl font-bold mb-4 text-foreground">SEO Optimization</h3>
                  <p className="text-foreground/70">Improve your search engine rankings and drive more organic traffic.</p>
                </CardContent>
              </Card>
            </Link>
            <Card className="bg-card border-border hover:border-foreground transition-colors duration-300">
              <CardContent className="p-8">
                <h3 className="text-xl font-bold mb-4 text-foreground">Maintenance & Support</h3>
                <p className="text-foreground/70">Ongoing website maintenance and technical support services.</p>
              </CardContent>
            </Card>
          </div>
        </div>
