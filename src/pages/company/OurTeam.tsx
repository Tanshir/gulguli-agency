        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {team.map((member, index) => (
              <Card key={member.name} className="bg-black border-gray-800 hover:border-white transition-colors duration-300">
                  ...
                  <div className="p-8">
                    ...
                    <div className="flex space-x-3">
                      {member.social.twitter && (
                        <Button size="sm" variant="outline" className="w-8 h-8 p-0 border-gray-700">
